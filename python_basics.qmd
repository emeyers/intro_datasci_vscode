...
A **character string** (or simply "string") in Python is a sequence of characters enclosed in either single quotes (`'...'`) or double quotes (`"..."`). Strings are used to represent text, such as words, sentences, or any other sequence of characters.
