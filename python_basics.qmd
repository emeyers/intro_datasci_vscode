...
# Note: I should get rid of the #| eval: false quarto comment to acutally show the output. However, there is a bug in quarto rendering the ^ from a Python error message, so if I evaluate this cell the book will not render to a pdf (although it will render to a website). 
