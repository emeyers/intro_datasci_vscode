...
| Explore and visualize | @sec-descriptive-stats, @sec-array-computations, @sec-data-visualization, @sec-maps |
| Model | @sec-statistical-inference, @sec-machine-learning |
| Interpret and communicate | @sec-statistical-inference |
...
| seaborn, Plotly | Statistical and interactive graphics | @sec-data-visualization |
| GeoPandas | Drawing data onto geographic maps | @sec-maps |
| scikit-learn | Machine learning models | @sec-machine-learning |
