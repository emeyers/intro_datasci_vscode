...
\begin{tcolorbox}[enhanced jigsaw, colback=white, leftrule=.75mm, toprule=.15mm, titlerule=0mm, coltitle=black, bottomtitle=1mm, rightrule=.15mm, breakable, toptitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-tip-color-frame, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Exercise}, left=2mm, bottomrule=.15mm, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, leftrule=.75mm, toprule=.15mm, titlerule=0mm, coltitle=black, bottomtitle=1mm, rightrule=.15mm, breakable, toptitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Solution}, left=2mm, bottomrule=.15mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0]
